...
public class UserActivity extends AppCompatActivity {
    ...
    EditText nameBox, yearBox, genderBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userId > 0) {
            ...
            genderBox.setText(String.valueOf(userCursor.getString(3)));
            userCursor.close();
        } else {
    ...
    public void save(View view) {
        ...
        cv.put(DatabaseHelper.COLUMN_GENDER, genderBox.getText().toString());
